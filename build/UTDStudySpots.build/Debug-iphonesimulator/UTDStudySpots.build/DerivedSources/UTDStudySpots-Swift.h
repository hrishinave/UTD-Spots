...
#ifndef UTDSTUDYSPOTS_SWIFT_H
#define UTDSTUDYSPOTS_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="UTDStudySpots",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC13UTDStudySpots11AppDelegate")
...
SWIFT_CLASS("_TtC13UTDStudySpots18BuildingAnnotation")
...
SWIFT_CLASS("_TtC13UTDStudySpots15LocationService")
...
@interface LocationService (SWIFT_EXTENSION(UTDStudySpots)) <CLLocationManagerDelegate>
...
SWIFT_CLASS("_TtC13UTDStudySpots13SceneDelegate")
...
SWIFT_CLASS("_TtC13UTDStudySpots19StudySpotAnnotation")
@interface StudySpotAnnotation : NSObject <MKAnnotation>
@property (nonatomic, readonly) CLLocationCoordinate2D coordinate;
@property (nonatomic, readonly, copy) NSString * _Nullable title;
@property (nonatomic, readonly, copy) NSString * _Nullable subtitle;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
